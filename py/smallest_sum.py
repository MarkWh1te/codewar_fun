...
# its elements are to be transformed by running the following operation on
...
Test.assert_equal(solution([9]), 9)
Test.assert_equal(solution([6, 9, 21]), 9)
Test.assert_equal(solution([1, 21, 55]), 3)
